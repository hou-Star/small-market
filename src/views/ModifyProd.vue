...
export default {
	...
	mounted(){
		...
		axios({
			...
			this.form.name = res.data[0].productName;
			this.form.region1 = res.data[0].productType;
			this.form.region2 = res.data[0].newDegree;
			this.form.price = res.data[0].productPrice;
			this.form.price = res.data[0].productPrice;
			this.form.desc = res.data[0].productDescription;
		});
	},
	beforeDestroy(){
